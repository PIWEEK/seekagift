	...
	<div id="content">
		...
		<div class="third">
			...
			<p>Ahora llegó el momento de elegir al agraciado.</p>
				<g:if test="${friends}">
				<a href="${createLink(controller:'socialNetwork', action:'friends')}">Tu lista de amigos...</a>
				</g:if>			
		...
		<div class="left">
			...
			<p><em>Seekagift es una iniciativa de Kaleidos, potenciada en la pi-week. El objetivo del proyecto es conectarse a las redes sociales para obtener de ellas la información más fidedigna posible con la que obtener ideas para poder regalar a tus amigos.</em></p>
		</div>
